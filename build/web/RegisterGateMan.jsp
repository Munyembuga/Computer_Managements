        ...
        <div class="maincontent">
            ...
            <div class="addpc-container">
                ...
                <table className="user-table">
                    ...
                    <tbody>
                        <c:forEach var="gateman" items="${listgateman}">
                            <tr class="table-body">
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-center">
                        <c:if test="${currentPage > 1}">
                            <li class="page-item">
                                <a class="page-link" href="<%=request.getContextPath()%>/gateman?page=${currentPage - 1}" aria-label="Previous">
                        ...
                        <c:forEach begin="1" end="${totalPages}" varStatus="page">
                            <li class="page-item <c:if test='${page.index == currentPage}'>active</c:if>'">
                                <a class="page-link" href="<%=request.getContextPath()%>/gateman?page=${page.index}">
                                    ${page.index}
                                </a>
                            </li>
                        </c:forEach>
                        <c:if test="${currentPage < totalPages}">
                            <li class="page-item">
                                <a class="page-link" href="<%=request.getContextPath()%>/gateman?page=${currentPage + 1}" aria-label="Next">
